...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("Duplicates: %s%n", ArrayUtils.findDuplicates(testArray));
        System.out.printf("Indices: %s%n", Arrays.toString(ArrayUtils.twoSum(testArray, 5)));
        ArrayUtils.reverseInPlace(testArray);
